    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                <form action="{{ route('teams.update', $teams->id) }}" method="POST" class="p-8 space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            placeholder="Bijv. Team Phoenix" value="{{ old('name', $teams->name) }}" required>
                    </div>

                    <input type="hidden" name="created_by" value="{{ $teams->created_by }}">
